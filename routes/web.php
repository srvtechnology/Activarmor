...
Route::get('download-pdf/{id}','Modules\Page\PageController@download')->name('download.pdf');
...
// verify 
Route::get('verify-email/{id}','Modules\Contact\ContactController@verify')->name('verify.email');