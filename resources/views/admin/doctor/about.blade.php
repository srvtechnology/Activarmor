...
@section('title')
<title>Activarmor | Manage About Doctor</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage About Doctor</h4>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                          @include('admin.includes.message')
                            <form role="form" action="{{route('manage.about.doctor.update')}}" method="post" id="banner" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group rm03">
                                  ...
                                  @else
                                    <img src="{{ URL::to('storage/app/public/about_min')}}/{{@$data->image}}" style="width: 100%;height: 400px" id="img2">
                                  @endif            
                                 </div>
                                  ...
                                  <div class="form-group">
                                        <label for="Email">Image (W X H : 445 × 608 px)</label>
                                  ...
                                  <div class="form-group rm03">
                                        ...
                                        <input type="text" name="heading_three" class="form-control" value="{{@$data->heading_three}}">
                                  </div>

                                  <div class="form-group rm03">
                                        <label for="Email">Heading Four</label>
                                        <input type="text" name="heading_four" class="form-control" value="{{@$data->heading_four}}">
                                  </div>

                                  <div class="form-group rm03">
                                        <label for="Email">Heading FIve</label>
                                        <input type="text" name="heading_five" class="form-control" value="{{@$data->heading_five}}">
                                  </div>

                                  <div class="form-group rm03">
                                        <label for="Email">Heading Six</label>
                                        <input type="text" name="heading_six" class="form-control" value="{{@$data->heading_six}}">
                                  </div>
