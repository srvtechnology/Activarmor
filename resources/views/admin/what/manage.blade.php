...
@section('title')
<title>Activarmor | Manage What Section</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage What Section</h4>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading rm02 rm04">
                          @include('admin.includes.message')
                            <form role="form" action="{{route('admin.manage.what.update')}}" method="post" id="what" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group rm03">
                                  ...
                                  @else
                                    <img src="{{ URL::to('storage/app/public/what_min')}}/{{@$data->image}}" style="width: 25%;height: 300px" id="img2">
                                  @endif            
                                 </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('admin.manage.what.content',['id'=>@$value->id])}}">Edit</a></li>
