            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.what')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
                </div>
            </div>
            <div class="row">
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit What Content</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                {{-- @include('admin.includes.message') --}}
                                <form role="form" action="{{route('admin.manage.what.content.update')}}" method="POST" id="searchdata" enctype="multipart/form-data">
                                    @csrf
