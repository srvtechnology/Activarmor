...
@section('title')
<title>Activarmor | Edit Sub Heading</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Edit Sub Heading</h4>
                    ...
                    <div>
                        ...
                        <div class="panel panel-default panel-fill">
                            <div class="panel-heading">
                                <h3 class="panel-title">Edit Sub Heading</h3>
                            </div>
                            <div class="panel-body rm02 rm04">
                                <form role="form" action="{{route('admin.manage.sub.heading.update')}}" method="POST" id="faq_form" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group rm03">
                                                <label for="AboutMe">Sub Heading</label>
                                                <input type="text"  name="name" id="mytextarea"  class="form-control"  placeholder="Heading" value="{{@$data->name}}"> 
                                    </div>
