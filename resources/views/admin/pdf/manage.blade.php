...
@section('title')
<title>Activarmor | Manage Pdf</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Pdf</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{@$value->name}}</td>
                                                    <td><a href="{{route('admin.manage.pdf.download',['id'=>@$value->pdf])}}" class="btn btn-success">Download Pdf</a></td>
                                                   ...
                                                   <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                 ...
                                                                 <li><a href="{{route('admin.manage.pdf.edit',['id'=>@$value->id])}}">Edit </a></li>
